...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    // 颜色渐变 黑色 -> 红色
    [rigthButton setTitleColor:XMGColor(rightScale, 0, 0) forState:UIControlStateNormal];
    [leftButton setTitleColor:XMGColor(leftScale, 0, 0) forState:UIControlStateNormal];
}
